class TriangleBuilder extends BrushBuilder;
...
function BuildCube( int Direction, float dx, float dy, float dz)
{
    ...
    Poly3i(Direction,n+0,n+1,n+2);
    Poly3i(Direction,n+4,n+3,n+5);
    Poly4i(Direction,n+1,n+4,n+5,n+2);
    Poly4i(Direction,n+0,n+2,n+5,n+3);
    Poly4i(Direction,n+0,n+3,n+4,n+1);
